    ...
    <div class="apsc-add-set-wrapper clearfix">
        <div class="apsc-panel">
            <div class="apsc-settings-header">
                ...
                <div class="apsc-logo">
                    <img src="<?php echo APIF_IMAGE_DIR; ?>/instagram.png" alt="<?php esc_attr_e('AccessPress Instagram Feed', 'if-feed'); ?>" />
                </div>

                <div class="apsc-socials">
                    <p><?php _e('Follow us for new updates', 'if-feed') ?></p>
                ...
                <div class="apsc-title"><?php _e('AccessPress Instagram Feed', 'if-feed'); ?></div>
            </div>
            ...
            <div class="apsc-boards-wrapper">
                <ul class="apsc-settings-tabs">
                    ...
                    <li><a href="javascript:void(0)" id="social-profile-settings" class="apsc-tabs-trigger apsc-active-tab"><?php _e('Instagram Profiles', 'if-feed') ?></a></li>

                    <li><a href="javascript:void(0)" id="display-settings" class="apsc-tabs-trigger"><?php _e('Display Settings', 'if-feed'); ?></a></li>
                    
                    <li><a href="javascript:void(0)" id="how_to_use-settings" class="apsc-tabs-trigger"><?php _e('How to use', 'if-feed'); ?></a></li>
